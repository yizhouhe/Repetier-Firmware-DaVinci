...
#define EXT0_STEPS_PER_MM 99  //106 //425 // 825.698 //457


// What type of sensor is used? (Themistor type)
...
// 5 is userdefined thermistor table 0 (Da Vinci Stock Themistor)
...
// for skeinforge 40 and later, steps to pull the plastic 1 mm inside the extruder, not out.  Overridden if EEPROM activated.
#define EXT1_STEPS_PER_MM 99  //319.8
...
#if DAVINCI==0
  #define UI_PRINTER_NAME    "  3D Printer "
