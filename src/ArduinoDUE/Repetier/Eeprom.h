...
//end davinci specific
  ...
  static inline void setRodRadius(float mm) {
    ...
    // The radius is not saved to printer variable now, it is all derived
    // parameters of fetching the radius, which if EEProm is off returns the
